  ...
  class reactor_context {
   public:
    reactor_context(config cfg,
                    ...
                    cudf_streaming::prefetch::memory::fixed_size_host_memory_resource* host_mr = nullptr)
   ...
   private:
    ...
    cudf_streaming::prefetch::memory::fixed_size_host_memory_resource* _host_mr{nullptr};
  };

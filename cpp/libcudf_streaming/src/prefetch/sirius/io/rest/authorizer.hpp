 ...
 *
 * @par Errors
 *   Implementations throw @c cudf_streaming::prefetch::io::credential_error on credential /
...
class request_authorizer {
 public:
   ...
   * @throw cudf_streaming::prefetch::io::credential_error on credential / signing failure.
   */
   ...
   *
   * @throw cudf_streaming::prefetch::io::credential_error when unsupported, or on signing failure.
   */
  [[nodiscard]] virtual authorized_request authorize_list(std::string_view /*bucket*/,
                                                          std::string_view /*canonical_query*/,
                                                          std::chrono::seconds /*timeout*/)
  {
    throw cudf_streaming::prefetch::io::credential_error(

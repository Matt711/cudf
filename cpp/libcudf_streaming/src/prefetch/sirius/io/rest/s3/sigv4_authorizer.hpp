...
namespace cudf_streaming::prefetch::io::rest::s3 {
...
class sigv4_authorizer_base : public request_authorizer {
 protected:
  ...
  /// @throw cudf_streaming::prefetch::io::credential_error on empty creds, empty region, or
  ///        malformed endpoint.
...
class sigv4_presigned_authorizer final : public sigv4_authorizer_base {
 public:
  /// @throw cudf_streaming::prefetch::io::credential_error on empty creds/region, malformed
  ...
  /// construction.
  /// @throw cudf_streaming::prefetch::io::credential_error on empty bucket / key or SigV4 failure.
  ...
  /// @throw cudf_streaming::prefetch::io::credential_error on empty bucket, an X-Amz-* key inside
...
class sigv4_header_authorizer final : public sigv4_authorizer_base {
 public:
  /// @throw cudf_streaming::prefetch::io::credential_error on empty creds/region or malformed
  ///        endpoint.

...
// ---------------------------------------------------------------------------
//
// Backed by a @c cudf_streaming::prefetch::memory::fixed_size_host_memory_resource.  Each
...
class buffer_pool {
 public:
  ...
  buffer_pool(cudf_streaming::prefetch::memory::memory_reservation_manager& reservation_manager,
 ...
 private:
  struct host_arena {
    int numa_id;
    std::unique_ptr<cudf_streaming::prefetch::memory::reservation> reservation;
    cudf_streaming::prefetch::memory::fixed_size_host_memory_resource* mr;
  };

...
class PDSDSPolarsQueries(PDSDSQueries):
    ...
    EXPECTED_CASTS: ClassVar[dict] = {
        ...
        28: [
            pl.col("B1_CNT").cast(COUNT_DTYPE),
            pl.col("B1_CNTD").cast(COUNT_DTYPE),
            pl.col("B2_CNT").cast(COUNT_DTYPE),
            pl.col("B2_CNTD").cast(COUNT_DTYPE),
            pl.col("B3_CNT").cast(COUNT_DTYPE),
            pl.col("B3_CNTD").cast(COUNT_DTYPE),
            pl.col("B4_CNT").cast(COUNT_DTYPE),
            pl.col("B4_CNTD").cast(COUNT_DTYPE),
            pl.col("B5_CNT").cast(COUNT_DTYPE),
            pl.col("B5_CNTD").cast(COUNT_DTYPE),
            pl.col("B6_CNT").cast(COUNT_DTYPE),
            pl.col("B6_CNTD").cast(COUNT_DTYPE),
        ],

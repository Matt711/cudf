...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    b1 = make_block(18, 28, 1939, 2939, 34, 54, 0, 5, "B1")
    b2 = make_block(1, 11, 35, 1035, 50, 70, 6, 10, "B2")
    b3 = make_block(91, 101, 1412, 2412, 17, 37, 11, 15, "B3")
    b4 = make_block(9, 19, 5270, 6270, 29, 49, 16, 20, "B4")
    b5 = make_block(45, 55, 826, 1826, 5, 25, 21, 25, "B5")
    b6 = make_block(174, 184, 5548, 6548, 42, 62, 26, 30, "B6")

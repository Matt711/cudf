...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # Cross-join both scalar results to simulate subquery merging
    result = promotional_sales.join(all_sales, how="cross").with_columns(
        [
    ...
    return result.sort(["promotions", "total"], nulls_last=True).limit(100)

...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # First, find orders that have multiple shipments from different warehouses (EXISTS clause)
    ...
    # Find orders that have returns (for NOT EXISTS clause)
    ...
    return (
        ...
        # EXISTS: order has multiple warehouses
        .join(
            multi_warehouse_orders,
        ...
        # NOT EXISTS: order has no returns
        .join(
            returned_orders,
            left_on="ws_order_number",

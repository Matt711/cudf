...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # Main query: Join customer_total_return with state averages and filter
    ...
    # Final query: Join with customer and customer_address, filter for TX
    # First filter customer_address for TX only
    ...
    return (
        ...
        .select(
            [
                ...
                "ca_city",
                "ca_county",
                "ca_state",  # This should be from the TX addresses join
                "ca_zip",
                "ca_country",
                "ca_gmt_offset",
                "ca_location_type",
        ...
        .sort(
            [
                ...
                "ca_city",
                "ca_county",
                "ca_state",  # current address state
                "ca_zip",
                "ca_country",
                "ca_gmt_offset",
                "ca_location_type",

...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    inner_query = (
        ...
        .filter(
            ...
            &
            # Complex OR conditions for item categories
            (
                # First condition: Books/Children/Electronics
                (
                ...
                |
                # Second condition: Women/Music/Men
                (
        ...
        .with_columns(
            [
                # Add window function: average monthly sales by manager
                pl.col("sum_sales")
                .mean()
                .over("i_manager_id")
    ...
    # Step 2: Apply the outer filter and final selections
    return (
        ...
        .filter(
            # Filter for deviations > 0.1 (10%)
            pl.col("deviation") > 0.1
        )
        .sort(

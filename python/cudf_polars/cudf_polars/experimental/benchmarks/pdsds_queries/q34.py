...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # Subquery: count tickets per customer
    dn = (
        ...
        #     ((pl.col("hd_buy_potential") == ">10000") | (pl.col("hd_buy_potential") == "unknown")) &
        ...
        #     (pl.col("s_county") == "Williamson County")  # All values are the same
        # )
        .filter(
            (
                (pl.col("d_dom").is_not_null() & pl.col("d_dom").is_between(1, 3))
                | (pl.col("d_dom").is_not_null() & pl.col("d_dom").is_between(25, 28))
            )
            & (
    ...
    return (
        ...
        .sort(
            by=[
                ...
                # Also SORT BY ss_ticket_number to match DuckDB
                "ss_ticket_number",
            ],

...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # First, calculate the average discount amount per item for the date range
    # This replaces the correlated subquery
    avg_discounts = (
        web_sales.join(
    ...
    # Main query: find web sales with excessive discounts
    return (
        ...
        # Join with the average discounts to get the threshold

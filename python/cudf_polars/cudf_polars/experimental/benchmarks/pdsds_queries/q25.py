...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    return (
        ...
        .filter(
            ...
            & (pl.col("d1_year").is_not_null() & (pl.col("d1_year") == 2001))
            & (pl.col("d2_moy").is_not_null() & pl.col("d2_moy").is_between(4, 10))
            & (pl.col("d2_year").is_not_null() & (pl.col("d2_year") == 2001))
            & (pl.col("d3_moy").is_not_null() & pl.col("d3_moy").is_between(4, 10))
            & (pl.col("d3_year").is_not_null() & (pl.col("d3_year") == 2001))
        )

...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # Store sales component - NULL ss_hdemo_sk
    store_component = (
    ...
    # Web sales component - NULL ws_ship_hdemo_sk
    web_component = (
    ...
    # Catalog sales component - NULL cs_warehouse_sk
    catalog_component = (
    ...
    # Combine all three components (UNION ALL) and aggregate
    return (

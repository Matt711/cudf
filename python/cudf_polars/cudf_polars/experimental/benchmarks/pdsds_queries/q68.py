...
def polars_impl(run_config: RunConfig) -> pl.LazyFrame:
    ...
    # Inner subquery: aggregate store sales by ticket/customer/address
    dn = (
    ...
    # Join with customer and current address
    return (
